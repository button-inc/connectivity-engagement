...
select has_function(
  'connectivity_engagement_private', 'verify_policy_not_present',
...
select lives_ok(
  $$
    select connectivity_engagement_private.verify_policy_not_present('test_policy', 'test_table_2');
  $$,
...
select lives_ok(
  $$
    select connectivity_engagement_private.verify_policy_not_present('nonexistant_policy', 'test_table');
  $$,
...
select throws_ok(
  $$
    select connectivity_engagement_private.verify_policy_not_present('test_policy', 'test_table');
  $$,
  'P0001',
