...
create table connectivity_engagement.some_table (
  id int primary key,
...
create trigger _set_user_id
  before insert or update on connectivity_engagement.some_table
  for each row execute procedure connectivity_engagement_private.set_user_id();

set jwt.claims.sub to '11111111-1111-1111-1111-111111111112';

insert into connectivity_engagement.some_table (id, some_column) values (1, 'foo');

select is(
  (select user_id from connectivity_engagement.some_table where id = 1),
...
update connectivity_engagement.some_table set user_id = (select id from connectivity_engagement.connectivity_engagement_user where uuid = '11111111-1111-1111-1111-111111111113');
