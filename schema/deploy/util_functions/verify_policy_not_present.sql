-- Deploy connectivity_engagement:database_functions/verify_policy_not_present to pg

begin;


-- Verifies if a policy exists
create or replace function connectivity_engagement_private.verify_policy_not_present(policy_name text, table_name text)
returns boolean
as
$function$
  declare
...
comment on function connectivity_engagement_private.verify_policy_not_present(text, text) is
