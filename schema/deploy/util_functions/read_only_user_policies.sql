-- Deploy connectivity_engagement:util_functions/read_only_user_policies to pg

begin;

create or replace function connectivity_engagement_private.read_only_user_policies(
  read_only_user text,
