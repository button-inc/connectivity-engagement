-- Deploy connectivity_engagement:database_functions/verify_grants to pg
-- requires: schema_connectivity_engagement

begin;

-- Verifies permission grants for all columns in a table
create or replace function connectivity_engagement_private.verify_grant(
  operation text,
...
comment on function connectivity_engagement_private.verify_grant(text, text, text, text) is
...
comment on function connectivity_engagement_private.verify_grant(text, text, text, text[], text) is
