...
begin;
  ...
  grant execute on function mocks.now to connectivity_engagement_internal, connectivity_engagement_external, connectivity_engagement_admin, connectivity_engagement_guest;
